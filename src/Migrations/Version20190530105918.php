 ...
 */
final class Version20190530105918 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, password, roles, user_firstname, user_lastname, user_adress, gender_id, phone FROM user');
        ...
        , user_firstname VARCHAR(60) NOT NULL, user_lastname VARCHAR(60) NOT NULL, user_adress VARCHAR(60) NOT NULL, phone VARCHAR(15) NOT NULL, CONSTRAINT FK_8D93D649708A0E0 FOREIGN KEY (gender_id) REFERENCES genders (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user (id, email, password, roles, user_firstname, user_lastname, user_adress, gender_id, phone) SELECT id, email, password, roles, user_firstname, user_lastname, user_adress, gender_id, phone FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, gender_id, email, roles, user_firstname, password, user_lastname, user_adress, phone FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, gender_id INTEGER DEFAULT NULL, roles CLOB DEFAULT NULL COLLATE BINARY, user_firstname VARCHAR(60) DEFAULT NULL COLLATE BINARY, user_lastname VARCHAR(60) DEFAULT NULL COLLATE BINARY, user_adress VARCHAR(60) DEFAULT NULL COLLATE BINARY, phone VARCHAR(15) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, gender_id, email, roles, user_firstname, password, user_lastname, user_adress, phone) SELECT id, gender_id, email, roles, user_firstname, password, user_lastname, user_adress, phone FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
}
